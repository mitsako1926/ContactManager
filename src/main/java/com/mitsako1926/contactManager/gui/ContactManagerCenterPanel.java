...
public final class ContactManagerCenterPanel extends JPanel{
	...
	ContactManagerCenterPanel(ContactService service){
		...
		//ADD THE LABEL AND THE PANEL FOR SORT TO THE TOP PANEL
		...
		//CONTACTS PANEL
		JPanel contactsPanel = new JPanel(new FlowLayout(FlowLayout.CENTER));
	...
	private void customizeList(JList<Contact> list) {
